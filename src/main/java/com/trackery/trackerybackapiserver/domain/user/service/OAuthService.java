 ...
 * 25. 6. 23.		inari		연동 서비스 및 컨트롤러 추가
 * 25. 6. 24.		inari		기능 개선 및 테스트코드 수정 및 추가
 * 25. 6. 24.		inari		URL만 생성 -> 직접 연동 에서 토큰 포함 URL 생성 -> 통합 로그인에서 연동 처리로 방식변경후 안쓰는 코드 삭제
 * 25. 6. 24.		inari		주석추가
 * 25. 6. 25.		inari		액세스토큰만 발급하여 쿠키에 담던 문제를 해결
 * 25. 6. 25.		inari		주석 추가
 * 25. 6. 26.		inari		탈퇴시 코드 스멜 제거
